        ...
        for (let area of obj.maps) {
            ...
            for (let object of area.objects) {
                switch (object.type) {
                    ...
                    case "hatReward": {
                        const hatReward = createHatReward(object.position[0], object.position[1], object.reward);
                        parsedArea.objects.hatReward.push(hatReward);

                        objectmenu.appendChild(hatReward.element);
                        hide(hatReward.element);
                        console.log(hatReward); 
                        break;
                    }
                    default: {
